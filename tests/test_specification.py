    ...
    def test_evaluator_identity_is_bound_for_every_execution(self):
        ...
        for scope, text, phrases in (
            ("manifest", manifest, (
                ...
                "unsigned canonical payload that includes `producer_id` and `producer_provenance` and omits both `evaluator_identity_evidence_ref` and `evaluator_identity_evidence_sha256`",
